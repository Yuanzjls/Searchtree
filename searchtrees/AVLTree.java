...
public class AVLTree<AnyType extends Comparable<? super AnyType>>
{
 ...
 public static long timeforinsert(AVLTree<Integer> H, int NUMS)
 {
	 
	 AVLTree<Integer> H_temp =  (AVLTree<Integer>) H;
 ...
 public static long timeforsearch(AVLTree<Integer> H, int NUMS)
 {
 ...
 public static long timefordelete(AVLTree<Integer> H, int NUMS)
 {
 ...
 public static long timefordeleteRandom(AVLTree<Integer> H, int NUMS)
 {
 ...
 public static void main( String [ ] args )
 {
     ...
     JFrame frame = new JFrame("Time for AVL(ms)");
